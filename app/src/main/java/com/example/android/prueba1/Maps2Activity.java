...
public class Maps2Activity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void onClick(View arg0) {
            ...
            if (txtRemision.getText().toString().equals("")) {
                Toast.makeText(getApplicationContext(), "Agregar cliente", Toast.LENGTH_LONG).show();
                }
                ...
                String primer_numero = remision_string.substring(0, 1);
                    ...
                    // Create class object
                    gps = new GPSTracker(Maps2Activity.this);
                    ...
                    if (gps.canGetLocation()) {
                        ...
                        //
                        String aEmailList[] = {"javierb@nervion.com.mx", "juanitap.ventas@nervion.com.mx"};
                        ...
                        String current_user_db = mAuth.getCurrentUser().getEmail().toString();
                            ...
                            intent.putExtra(Intent.EXTRA_SUBJECT, "Visita comercial " + numPedido);
                            intent.putExtra(Intent.EXTRA_EMAIL, aEmailList);
                            intent.putExtra(Intent.EXTRA_TEXT, "Cliente: " + numPedido +
                                    "\n Visitado por: " + current_user_db +
    ...
    private void agregarEntrega(Entrega e) {
        ...
        String url = "https://appsionmovil.000webhostapp.com/agregar_entrega.php?";
        ...
        cliente.post(url + parametros, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (statusCode==200){
                    Toast.makeText(Maps2Activity.this, "Entrega registrada",Toast.LENGTH_SHORT).show();
                }
            }
